...
class PlanetsUi(QWidget):  # Changed from QMainWindow
    ...
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        # Planets table
        self.planets_table_model = PlanetsUi.PlanetsTableModel(self)
        self.planets_table_view = PlanetsUi.PlanetsTableView(self)
        self.planets_table_proxy_model = PlanetsUi.PlanetsTableProxyModel(self)
